...
export default function EditProduct() {
    ...
    const handleInput = e => setSelectedItem({...selectedItem, [e.target.name]:e.target.value})
    ...
    const handleSubmit = async ev => {
        ...
        try {
            ...
            const result = await axiosInstance.post('/products/edit', formData, postOptions).then(res => res)
            console.log(result)
        } catch (error) {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-2">
                    ...
                    <label className="" htmlFor="image">
                        ...
                        <input type="file" name="image" filename={selectedItem.product_image} id="image" />
                    </label>
                </div>
                <button className="bg-green-500 text-white px-4 py-2 rounded" type="submit">Save Changes</button>
            </form>
        </div>
        }
    </div>
